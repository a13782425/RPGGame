...
namespace CreativeSpore.RpgMapEditor
{
    ...
    public class AutoTileMapEditor : Editor
    {
        ...
        public void OnSceneGUI()
        {
            ...
            Vector3 rToolsBootomRight = HandleUtility.GUIPointToWorldRay(new Vector3(200f, 30f)).origin;
        ...
        void DrawCollisions()
        {
            ...
            for (float y = vTopLeft.y; y <= vBottomRight.y; y += MyAutoTileMap.Tileset.TileWorldHeight / 4)
            {
                ...
                {
                    int _x, _y;
                    eTileCollisionType collType = MyAutoTileMap.GetAutotileCollisionAtPosition(new Vector3(x, -y), out _x, out _y);
