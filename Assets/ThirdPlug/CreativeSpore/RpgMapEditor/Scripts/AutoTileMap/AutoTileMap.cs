...
namespace CreativeSpore.RpgMapEditor
{
    ...
    public class AutoTileMap : MonoBehaviour
    {
        ...
        public ActionCallBackDelegate OnLoadBefore;

        public ArgCallBackDelegate OnLoadEnd;
        ...
        /// <returns></returns>
        public eTileCollisionType GetAutotileCollisionAtPosition(Vector3 vPos, out int x, out int y)
        {
        ...
        /// <returns></returns>
        public Vector2 GetPosByTilePos(int tile_x, int tile_y)
        {
            return GetPosByTilePos(new Vector2(tile_x, tile_y));
        }
        /// <summary>
        /// 根据瓷砖坐标获取世界坐标
        /// </summary>
        ...
        /// <param name="tile_y"></param>
        /// <returns></returns>
        public Vector2 GetPosByTilePos(Vector2 tilePos)
        {
            float x = this.Tileset.TileWorldWidth * (tilePos.x + 1);
            float y = this.Tileset.TileWorldHeight * (tilePos.y + 1);
            return new Vector2(x - this.Tileset.TileWorldWidth / 2, -y + this.Tileset.TileWorldHeight / 2);
        }
        ...
        /// <param name="tile_y"></param>
        /// <returns></returns>
        public Vector2 GetTilePosByPos(int pos_x, int pos_y)
        {
            return GetTilePosByPos(new Vector2(pos_x, pos_y));
        }
        /// <summary>
        /// 根据世界坐标获取瓷砖坐标
        /// </summary>
        ...
        /// <param name="tile_y"></param>
        /// <returns></returns>
        public Vector2 GetTilePosByPos(Vector3 pos)
        {
            pos -= transform.position;
            // transform to pixel coords
            pos.y = -pos.y;

            pos *= AutoTileset.PixelToUnits;
            if (pos.x >= 0 && pos.y >= 0)
            {
                int tile_x = (int)pos.x / Tileset.TileWidth;
                int tile_y = (int)pos.y / Tileset.TileWidth;
