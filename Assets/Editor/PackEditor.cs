...
public class PackEditor
{
    ...
    static void ZipPack()
    {
        ...
        string savePath = Application.dataPath + "/Resources/Data/Maps/";
        ...
        ZipUtils.Zip(new string[] { str }, Application.dataPath + "/StreamingAssets/Default");
        Debug.LogError("压缩完成");
    }
    ...
    {
        string str = Application.dataPath + "/Resources/Data";
        ZipUtils.UnzipFile(Application.dataPath + "/StreamingAssets/Default", Application.persistentDataPath + "/Default");
        Debug.LogError("解压完成");
    }
